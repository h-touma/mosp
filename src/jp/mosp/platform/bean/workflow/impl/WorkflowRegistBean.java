...
public class WorkflowRegistBean extends PlatformBean implements WorkflowRegistBeanInterface {
	...
	public void initBean() throws MospException {
		...
		workflowCommentRefer = (WorkflowCommentReferenceBeanInterface)createBean(WorkflowCommentReferenceBeanInterface.class);
...
//		}
	...
	protected void setApprovalRoute(WorkflowDtoInterface dto, String personalId, Date targetDate, int workflowType)
		...
		// ルート適用情報取得及び確認
		RouteApplicationDtoInterface routeApp = platformMaster
			.getRouteApplication(personalId, targetDate, workflowType);
		if (routeApp == null) {
			// メッセージ設定
