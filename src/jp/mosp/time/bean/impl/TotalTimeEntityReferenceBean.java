...
public class TotalTimeEntityReferenceBean extends TimeBean implements TotalTimeEntityReferenceBeanInterface {
	...
	public void initBean() throws MospException {
		...
		workTypeChangeRequestDao = (WorkTypeChangeRequestDaoInterface)createDao(WorkTypeChangeRequestDaoInterface.class);
		...
		attendanceTransactionDao = (AttendanceTransactionDaoInterface)createDao(AttendanceTransactionDaoInterface.class);
	}
	...
	public RequestDetectEntityInterface getRequestDetectEntity(TotalTimeEntityInterface totalTimeEntity)
			throws MospException {
		// 申請確認エンティティを準備
		RequestDetectEntityInterface entity = (RequestDetectEntityInterface)createObject(RequestDetectEntityInterface.class);
