...
public interface PaidHolidayProportionallyDaoInterface extends BaseDaoInterface {
	 ...
	 */
	@Deprecated
	PaidHolidayProportionallyDtoInterface findForKey(String paidHolidayCode, Date activateDate) throws MospException;
	 ...
	 */
	@Deprecated
	List<PaidHolidayProportionallyDtoInterface> findForHistory(String paidHolidayCode) throws MospException;
