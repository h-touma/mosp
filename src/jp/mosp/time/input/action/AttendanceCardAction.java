...
public class AttendanceCardAction extends TimeAction {
	...
	protected void setWorkType(RequestUtilBeanInterface requestUtil) throws MospException {
		...
		String workTypeCode = scheduleUtil
			.getScheduledWorkTypeCode(vo.getPersonalId(), vo.getTargetDate(), requestUtil);
		// 法定休日
...
//		vo.setTxtEndTimeMinute(DateUtility.getStringMinute(dto.getEndTime()));
	...
	protected void chkDuplRest(AttendanceDtoInterface dto) throws MospException {
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtRestStartHour1(), vo.getTxtRestStartMinute1(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtRestStartHour2(), vo.getTxtRestStartMinute2(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtRestStartHour3(), vo.getTxtRestStartMinute3(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtRestStartHour4(), vo.getTxtRestStartMinute4(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtRestStartHour5(), vo.getTxtRestStartMinute5(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtRestStartHour6(), vo.getTxtRestStartMinute6(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtPublicStartHour1(), vo.getTxtPublicStartMinute1(),
							vo.getTxtPublicEndHour1(), vo.getTxtPublicEndMinute1(), public1)) {
				return;
			}
		}
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtPublicStartHour2(), vo.getTxtPublicStartMinute2(),
							vo.getTxtPublicEndHour2(), vo.getTxtPublicEndMinute2(), public2)) {
				return;
			}
		}
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtPrivateStartHour1(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtPrivateStartHour2(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayAStartHour1(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayAStartHour2(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayAStartHour3(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayAStartHour4(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayBStartHour1(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayBStartHour2(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			...
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayBStartHour3(),
		...
		if (baseDateStart != null && baseDateEnd != null) {
			// 直行・直帰かつ整合性がとれない場合
			if (isDirect
					&& !chkTimeValidate(startTime, endTime, vo.getTxtMinutelyHolidayBStartHour4(),
