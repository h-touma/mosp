...
public class TotalTimeUtility {
	 ...
	 * @return 代休申請リスト
	 */
	public static List<SubHolidayRequestDtoInterface> getSubHolidayRequestList(
			List<SubHolidayRequestDtoInterface> list, Map<Long, WorkflowDtoInterface> workflowMap, Date targetDate) {
		// 代休申請リストを準備
	...
	public static WorkTypeChangeRequestDtoInterface getWorkTypeChangeRequestList(
			List<WorkTypeChangeRequestDtoInterface> list, Map<Long, WorkflowDtoInterface> workflowMap, Date targetDate) {
		//  勤務形態変更申請情報毎に処理
