...
public abstract class TimeAction extends PlatformAction {
	...
	*/
	...
	public int getTimeValue(String hour, String minute) {
		...
		return getTimeValue(getInt(hour), getInt(minute));
	}
	...
	*/
	...
	protected String getRequestInfo(ManagementRequestListDtoInterface dto) throws MospException {
		...
		// 勤怠である場合
//		AttendanceDtoInterface attendanceDto = attendance.findForWorkflow(dto.getWorkflow());
