...
(
  ...
  prescribed_working_hours_per_week integer NOT NULL DEFAULT 0,
...
(
  ...
  mail_address character varying(30) NOT NULL DEFAULT '',
...
(
  ...
  health_ins_per integer NOT NULL DEFAULT 0,
  nurse_ins_com integer NOT NULL DEFAULT 0,
  nurse_ins_per integer NOT NULL DEFAULT 0,
  welfare_ins_com integer NOT NULL DEFAULT 0,
  welfare_ins_per integer NOT NULL DEFAULT 0,
...
COMMENT ON COLUMN cod_payment.health_ins_per IS '健康保険料(本人負担)';
COMMENT ON COLUMN cod_payment.nurse_ins_com IS '介護保険料(事業主負担)';
COMMENT ON COLUMN cod_payment.nurse_ins_per IS '介護保険料(本人負担)';
COMMENT ON COLUMN cod_payment.welfare_ins_com IS '厚生年金保険料(事業主負担)';
COMMENT ON COLUMN cod_payment.welfare_ins_per IS '厚生年金保険料(本人負担)';
...
COMMENT ON COLUMN cod_payment.soc_ins_total IS '社会保険料合計';
COMMENT ON COLUMN cod_payment.deduction_total IS '控除額合計';
