...
%>
	...
	<table class="ButtonTable">
		<tr>
			...
			<td class="ButtonTd" id="">
				<button type="button" id="btnAllReflection" class="Name4Button" onclick="submitRegistExtra(event, '', null,confirmAllReflection, '<%= ScheduleCardAction.CMD_ALL_REFLECTION %>');"><%= params.getName("FiscalYear","Reflection") %></button>
			</td>
		</tr>
	</table>
</div>
