	...
	<table class="ListTable" id="Proportionally">
		...
		<tbody>
			<tr>
				...
				<td class="TitleTd" rowspan="2"><%= params.getName("5DaysOrMore") %></td>
				<td class="TitleTd" rowspan="2"><%= params.getName("217DaysOrMore") %></td>
			...
			<tr>
				<td class="TitleTd" rowspan="5"><%= params.getName("LessThan30Hours") %></td>
			</tr>
			<tr>
